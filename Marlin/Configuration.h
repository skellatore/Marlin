...
#define STRING_CONFIG_H_AUTHOR "(ShapeNerd, 510Custom)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 18.98
  #define DEFAULT_bedKi 0.95
  #define DEFAULT_bedKd 253.32
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 35, 0, 1.91 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define G26_XY_FEEDRATE         26    // (mm/s) Feedrate for XY Moves for the G26 Mesh Validation Tool.
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 75, 75, 75, 75 } // (mm) Left, Front, Right, Back insets
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 75    // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT 75    // Y point for Z homing when homing all axes (G28).
#endif
